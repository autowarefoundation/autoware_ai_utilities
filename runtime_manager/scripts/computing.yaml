...
- subs :
  - name : Localization
    ...
    - name : lidar_localizer
      ...
      - name : ndt_matching
        ...
        gui  :
          dialog_height : 550
          stat_topic : [ /ndt_stat.NDTStat.exe_time ]
          x  :
            user_category : ''
          yaw:
            flags : [ nl ]
      ...
      - name : icp_matching
        ...
        gui  :
          dialog_height : 400
    - name : fusion_localizer
      desc : fusion_localizer desc sample
      subs :
      - name : ekf_localizer
        desc : pose and twist fusion for robust localization
        cmd  : roslaunch ekf_localizer ekf_localizer.launch
        param : ekf_localizer_param
        gui  :
          dialog_height : 700
          dialog_width  : 600
          ...
          pose_stddev_x:
             flags : [ nl ]
             depend : use_pose_with_covariance
             depend_bool : 'lambda v : v == 0'
             flags : [ nl ]
          pose_stddev_y:
             flags : [ nl ]
          ...
          twist_stddev_vx:
             flags : [ nl ]
             depend : use_twist_with_covariance
             depend_bool : 'lambda v : v == 0'
             flags : [ nl ]
          twist_stddev_wz:
             flags : [ nl ]
          ...
          input_twist_name:
             depend : use_twist_with_covariance
             depend_bool : 'lambda v : v == 0'
          input_twist_with_cov_name:
             depend : use_twist_with_covariance
             depend_bool : 'lambda v : v == 1'
    - name : twist_generator
      desc : twist_generator
      subs :
      - name : vehicle_status_converter
        desc : twist generator from vehicle_status
        cmd  : roslaunch twist_generator vehicle_status_converter.launch
        param : vehicle_status_converter_param
        gui  :
          dialog_height : 200
      ...
      - name : vel_pose_connect
        ...
        gui  :
           ...
           topic_twist_stamped:
             ...
             flags : [ nl ]
             prop  : 1
    - name : localizer_diagnosis
      desc : localizer_diagnosis
      subs :
      - name : vel_pose_diff_checker
        desc : vel_pose_diff_checker
        cmd  : roslaunch vel_pose_diff_checker vel_pose_diff_checker.launch
        param: vel_pose_diff_checker
        gui :
          dialog_height : 350
  ...
  - name : Detection
    ...
    - name : vision_tracker
      ...
      - name : vision_beyond_track
        desc : Beyond Pixel based object tracker
        cmd  : roslaunch vision_beyond_track vision_beyond_track.launch
        param: vision_beyond_track_params
        gui  :
          camera_info_src :
            flags  : [ nl ]
    ...
    - name : lidar_detector
      ...
      - name : lidar_euclidean_cluster_detect
        ...
        gui  :
          ...
          sync :
            func : self.button_synchronization.GetValue()
      - name : lidar_cnn_baidu_detect
        desc : lidar_cnn_segmentation_baidu_detect. Requires Caffe framework
        cmd  : roslaunch lidar_apollo_cnn_seg_detect lidar_apollo_cnn_seg_detect.launch
        param: lidar_cnn_baidu_params
      - name : lidar_point_pillars
        desc : lidar_point_pillars. Requires CUDA and TensorRT
        cmd  : roslaunch lidar_point_pillars lidar_point_pillars.launch
        param: lidar_point_pillars_params
      - name : lidar_naive_l_shape_detect
        desc : lidar_naive_l_shape_detect desc sample
        cmd  : roslaunch lidar_naive_l_shape_detect lidar_naive_l_shape_detect.launch
        param: lidar_naive_l_shape_detect_param
        gui  :
          sync :
            func : self.button_synchronization.GetValue()
      - name : lidar_shape_estimation
        desc : lidar_shape_estimation desc sample
        cmd  : roslaunch lidar_shape_estimation shape_estimation_clustering.launch
        param: lidar_shape_estimation_param
        gui  :
          sync :
            func : self.button_synchronization.GetValue()
    ...
    - name : lidar_tracker
      ...
      subs :
        - name : imm_ukf_pda_track
          desc : imm_ukf_pda_track desc sample
          cmd  : roslaunch imm_ukf_pda_track imm_ukf_pda_track_option.launch
          param: imm_ukf_pda_track_param
          gui  :
            dialog_width  : 600
            dialog_height : 450
            downsample_cloud :
    ...
    - name : trafficlight_recognizer
      ...
      - name : feat_proj
        ...
        cmd  : roslaunch trafficlight_recognizer feat_proj_option.launch
        param: feat_proj
        gui  :
          flags : [ need_camera_info ]
          sel_cam_dialog_only : [ camera_id ]
  ...
  - name : Semantics
    ...
    - name : wayarea2grid
      ...
      cmd  : roslaunch object_map wayarea2grid_option.launch
      param: wayarea2grid
      gui  :
        dialog_width  : 650
        dialog_height : 350
    ...
    - name : costmap_generator
      desc : costmap_generator desc sample
      cmd  : roslaunch costmap_generator costmap_generator_option.launch
      param: costmap_generator_param
      gui  :
        dialog_width  : 400
        dialog_height : 400
        sync :
  ...
  - name : Prediction
    desc : Prediction desc sample
    subs :
    - name: motion_predictor
      desc: motion_predictor desc samples
      subs:
      - name : naive_motion_predict
        desc : naive_motion_predict desc sample
        cmd  : roslaunch naive_motion_predict naive_motion_predict.launch
        param: naive_motion_predict_param
        gui  :
          sync :
            func : self.button_synchronization.GetValue()
  ...
  - name : Mission Planning
    ...
    - name : lane_planner
      ...
      - name : lane_rule
        ...
        cmd  : roslaunch lane_planner lane_rule_option.launch
        param: lane_rule
      - name : lane_stop
...
#    - name : way_planner (OpenPlanner - old ver)
...
#        param: ff_waypoint_follower
    ...
    - name : waypoint_planner
      ...
      - name : velocity_set
        ...
        cmd  : roslaunch waypoint_planner velocity_set_option.launch
        param: velocity_set
        gui  :
    ...
    - name : waypoint_follower
      ...
      subs :
       - name : pure_pursuit
         ...
         cmd  : roslaunch pure_pursuit pure_pursuit.launch
         ...
         gui  :
           ...
           stat_topic : [ lf ]
       - name : mpc_follower
         desc : model predictive control based path following
         cmd  : roslaunch mpc_follower mpc_follower.launch
         param: mpc_follower
         gui  :
           dialog_width  : 600
           dialog_height : 750
           ...
           qp_solver_type :
             flags : [ nl ]
           path_smoothing_times:
             depend : enable_path_smoothing
             depend_bool : 'lambda v : v == True'
           path_filter_moving_ave_num:
             depend : enable_path_smoothing
             depend_bool : 'lambda v : v == True'
       - name : twist_filter
         desc : twist_filter desc sample
         cmd  : roslaunch twist_filter twist_filter.launch
         param: twist_filter
       - name : wf_simulator
         desc : waypoint follower simulator
         cmd  : roslaunch wf_simulator wf_simulator.launch
         param: wf_simulator
         gui  :
           dialog_width  : 500
           dialog_height : 600
           ...
           vel_lim :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST" or v == "DELAY_STEER" or v == "CONST_ACCEL_TWIST"'
           angvel_lim :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST" or v == "CONST_ACCEL_TWIST"'
           accel_rate :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST" or v == "CONST_ACCEL_TWIST"'
           ...
           vel_time_delay :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST" or v == "DELAY_STEER"'
           vel_time_constant :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST" or v == "DELAY_STEER"'
           angvel_time_delay :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST"'
           angvel_time_constant :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_TWIST"'
           steer_lim :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_STEER"'
           steer_rate_lim :
             flags : [ nl ]
             depend : vehicle_model_type
             depend_bool : 'lambda v : v == "DELAY_STEER"'
    ...
    - name : OpenPlanner - Local planning
      ...
      - name : op_motion_predictor
        desc : predict behavior and trajectories for moving vehicles
        cmd  : roslaunch op_local_planner op_motion_predictor.launch
        param: op_motion_predictor
      - name : op_trajectory_evaluator
        desc : evaluate candidate rollout trajectory against the tracked obstacles
        cmd  : roslaunch op_local_planner op_trajectory_evaluator.launch
        param: op_trajectory_evaluator
      - name : op_behavior_selector
        desc : Decision making by selecting best behavior for local planner
        cmd  : roslaunch op_local_planner op_behavior_selector.launch

    - name : OpenPlanner - Utilities
      desc : Testing UI, Loggers , ..
      subs :
      - name : op_pose2tf
        desc : Publish transformation from ndt_pose read from rosbag file
        cmd  : roslaunch op_utilities op_pose2tf.launch
        param: op_pose2tf
      - name : op_bag_player
        desc : Send step by step simulation signal, read ready for localization rosbags and navigate them frame by frame
        cmd  : roslaunch op_utilities op_bag_player.launch
        param: op_bag_player
    - name : OpenPlanner - Simulator
      desc : Car, Signs, Detection Simulation for OpenPlanner Test
      subs :
      - name : op_perception_simulator
        desc : Simulate euclidean cluster for LIDAR based object detection of simulated cars
        cmd  : roslaunch op_simulation_package op_perception_simulator.launch
        param: op_perception_simulator
      - name : op_signs_simulator
      ...
      - name : op_car_simulator
        desc : Simulate a car using OpenPlanner
        cmd  : roslaunch op_simulation_package op_car_simulator_1.launch
        param: op_car_simulator
        gui  :
          dialog_width  : 600
          dialog_height : 550
  ...
  - name : Decision
    ...
    - name : decision_maker(experimental)
...
params :
  ...
  - name  : imm_ukf_pda_track_param
    ...
    - name    : tracker_input_topic
      ...
      v       : /detection/fusion_tools/objects
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : tracking_frame
    ...
    - name    : vectormap_frame
      desc    : vectormap_frame_ desc sample
      label   : 'vectormap frame'
      kind    : str
      v       : map
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : life_time_threshold
      desc    : The minimum frames for targets to be visualized
      label   : 'life time threshold'
      min       : 1
      max       : 20
      v       : 8
      cmd_param :
    ...
    - name    : gating_threshold
      desc    : The value of gate threshold for measurement validation.
    ...
    - name    : gate_probability
      desc    : The probability that the gate contains the true measurement
    ...
    - name    : detection_probability
      desc    : The probability that a target is detected
      ...
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : static_velocity_threshold
      desc    : The velocity threshold for classifying static/dynamic
      label   : 'static velocity threshold'
      min       : 0
      max       : 10
      v       : 0.5
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : static_num_history_threshold
      desc    : The amount of frames the velocity is averaged over to compare to `static_velocity_threshold
      label   : 'static num history threshold'
      min       : 0
      max       : 20
      v       : 3
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : prevent_explosion_threshold
      desc    : threshold for preventing ukf from explosion
      label   : 'prevent explosion threshold'
      min       : 0
      max       : 10000
      v       : 1000
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : lane_direction_chi_threshold
      desc    : threshold for direction chi squared distribution
      label   : 'lane direction chi threshold'
      min       : 0.0
      max       : 20
      v       : 2.71
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : nearest_lane_distance_threshold
      desc    : threshold for nearest lane distance
      label   : 'nearest lane distance threshold'
      min       : 0.0
      max       : 20
      v       : 1.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : merge_distance_threshold
      desc    : Distance to merge objects tracker output in meters. Default 0.5m
      label   : 'merge_distance_threshold [meters]'
      min       : 0.0
      max       : 2.0
      v       : 0.5
      cmd_param :
    ...
    - name      : use_sukf
      ...
      cmd_param :
        ...
        delim     : ':='
    - name      : use_map_info
      desc      : Use map lane direction assisted tracking
      label     : use_map_info
      kind      : checkbox
      v         : False
      cmd_param :
        ...
        delim     : ':='
    - name      : use_ll2
      desc      : Use Lanelet2 map format
      label     : Lanelet2 (default VectorMap)
      kind      : checkbox
      v         : False
      cmd_param :
        dash      : ''
  ...
  - name  : lidar_kf_contour_track_param
    ...
    - name : max_object_size
      ...
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : vector_map_filter_distance
      desc : Filtering distance from object to vector map center line if available
      label: Vector Map Filter Distance
      min  : 0.0
      max  : 20.0
      v    : 2.0
      cmd_param:
        ...
        delim    : ':='
    - name : enableLogging
      desc : Enable Writ csv of internal tracking state
      label: Enable CSV Logs
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
    ...
    - name : enableSimulationMode
      desc : Enable Representing Ego vehicle and simulated vehicles by special IDs
      label: Enable OpenPlanner Perception Simulation
      kind : checkbox
      v    : True
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableStepByStepMode
      desc : Enable Step by Step Tracking Test
      label: Enable Step by Step Test
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
  ...
  - name  : gnss
    ...
    - name    : plane
      ...
      cmd_param :
        ...
        delim       : ':='
    - name    : sim_mode
      desc    : Enable simulation mode - plane origin at (0°, 0°)
...
#      v     : 0
    ...
    - name      : get_height
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : output_log_data
      desc      : output ndt log data
      label     : Output Log Data
      kind      : checkbox
      v         : False
      cmd_param :
        dash      : ''
  ...
  - name  : waypoint_follower
    ...
    - name  : param_flag
      ...
      - Dialog
      descs :
      - use velocity on waypoints
      - use constant velocity
      v     : 0
    - name  : velocity
      desc  : velocity in dialog mode
      label : Velocity
      min   : 0
      max   : 60
      v     : 5.0
    - name  : lookahead_distance
      desc  : lookahead distance in dialog mode
      label : Lookahead Distance
      min   : 0
      max   : 30
      v     : 4.0
    - name  : lookahead_ratio
      desc  : velocity proportional coefficient for lookahead distance in waypoint mode
      label : lookahead_ratio
      min   : 0.0
      max   : 5.0
      v     : 2.0
    - name  : minimum_lookahead_distance
      desc  : minimum lookahead distance in waypoint mode
      label : minimum_lookahead_distance
      min   : 0.0
      max   : 20.0
      v     : 6.0
    - name  : displacement_threshold
      desc  : displacement_threshold
      label : displacement_threshold
      min   : 0
      max   : 1.0
      v     : 0.0
    - name  : relative_angle_threshold
      desc  : relative_angle_threshold
      label : relative_angle_threshold
      min   : 0
      max   : 90
      v     : 0
    - name    : is_linear_interpolation
      desc    : use linear interpolation when calculate target waypoint
    ...
    - name    : publishes_for_steering_robot
      ...
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : add_virtual_end_waypoints
      desc    : add virtual end waypoints to reach end waypoint
      label   : 'Add virtual end waypoints'
      kind    : checkbox
      v       : False
      cmd_param :
        dash        : ''
  ...
  - name  : mpc_follower
    ...
    - name    : show_debug_info
      desc    : show_debug_info
      label   : 'show_debug_info '
      kind    : checkbox
      v       : False
      cmd_param :
        dash        : ''
    ...
    - name    : vehicle_model_type
      desc    : vehicle model for mpc predioction
      label   : vehicle_model_type
      kind    : radio_box
      choices : ['kinematics','kinematics_no_delay','dynamics']
      descs   : ['kinematics','kinematics_no_delay','dynamics']
      choices_type : str
      v       : kinematics
      cmd_param:
        dash     : ''
        delim    : ':='
    - name  : qp_solver_type
      desc  : QP solver for mpc optimization
      label : qp_solver_type
      kind  : radio_box
      choices:
      - unconstraint
      - unconstraint_fast
      - qpoases_hotstart
      descs :
      - unconstraint least square
      - unconstraint least square (fast, but low accuracy)
      - constraint with qpOASES hotstart
      choices_type : str
      v       : unconstraint_fast
      cmd_param :
        dash        : ''
    ...
    - name  : ctrl_period
      ...
      max   : 0.1
      v     : 0.03
    - name  : admisible_position_error
      desc  : stop vehicle if tracking error exceeds this limit
      label : admisible position error [m]
      min   : 1.0
      max   : 100.0
      v     : 5.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : admisible_yaw_error_deg
      desc  : stop vehicle if tracking error exceeds this limit
      label : admisible yaw error [deg]
      min   : 1.0
      max   : 360.0
      v     : 90.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_prediction_horizon
      desc  : mpc_prediction_horizon
      ...
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_prediction_sampling_time
      desc  : mpc_prediction_sampling_time
      label : prediction sampling time [s]
      min   : 0.01
      max   : 1.0
      v     : 0.1
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_lat_error
      desc  : mpc_weight_lat_error
      label : weight lateral error
      min   : 0.0
      max   : 10.0
      v     : 0.1
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_terminal_lat_error
      desc  : mpc_weight_terminal_lat_error
      label : weight terminal lateral error
      min   : 0.0
      max   : 100.0
      v     : 10.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_heading_error
      desc  : mpc_weight_heading_error
      label : weight heading error
      min   : 0.0
      max   : 10.0
      v     : 0.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_heading_error_squared_vel_coeff
      desc  : mpc_weight_heading_error_squared_vel_coeff
      label : weight heading error vel squared coeff
      min   : 0.0
      max   : 10.0
      v     : 0.3
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_terminal_heading_error
      desc  : mpc_weight_terminal_heading_error
      label : weight terminal heading error
      min   : 0.0
      max   : 100.0
      v     : 0.1
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_lat_jerk
      desc  : mpc_weight_lat_jerk
      label : weight lateral jerk
      min   : 0.0
      max   : 10.0
      v     : 0.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_steering_input
      desc  : mpc_weight_steering_input
      label : weight steering input
      min   : 0.0
      max   : 10.0
      v     : 1.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_weight_steering_input_squared_vel_coeff
      desc  : mpc_weight_steering_input_squared_vel_coeff
      label : weight steering input vel squared coeff
      min   : 0.0
      max   : 10.0
      v     : 0.25
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : mpc_zero_ff_steer_deg
      desc  : ignore feedforward when it is smaller than this value
      label : feedforward zero-angle threshold [deg]
      min   : 0.0
      max   : 10.0
      v     : 2.0
      cmd_param :
    ...
    - name    : enable_path_smoothing
      desc    : enable_path_smoothing
      label   : 'enable_path_smoothing'
      kind    : checkbox
      v       : True
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : path_smoothing_times
      desc  : path_smoothing_times
      label : path smoothing number of times
      min   : 0
      max   : 3
      v     : 1
      cmd_param :
    ...
    - name  : path_filter_moving_ave_num
      desc  : moving average number for path smoothing
      label : moving average number for path smoothing
      min   : 1
      max   : 50
      v     : 35
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : curvature_smoothing_num
      desc  : index number distance for curvature calculation
      label : curvature smoothing number
      min   : 1
      max   : 50
      v     : 35
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : steering_lpf_cutoff_hz
      desc  : steering_lpf_cutoff_hz
      label : steering lpf cutoff freq [Hz]
      min   : 0.1
      max   : 10.0
      v     : 3.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : vehicle_model_steer_tau
      desc  : vehicle_model_steer_tau
      label : steering tau
      min   : 0.001
      max   : 5.0
      v     : 0.3
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : delay_compensation_time
      desc  : vehicle_model steering delay_compensation_time
      label : steering time delay [s]
      min   : 0.00
      max   : 3.0
      v     : 0.2
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : vehicle_model_wheelbase
      desc  : vehicle_model_wheelbase
      label : wheelbase [m]
      v     : 2.9
      cmd_param :
        dash        : ''
    ...
    - name  : steer_lim_deg
      desc  : steer_lim_deg
      label : steering angle limit [deg]
      v     : 35.0
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : qpoases_max_iter
      desc  : max iteration number for qpoases convex optimization
      label : qpoases_max_iter
      v     : 500
      cmd_param :
        dash        : ''
        delim       : ':='
  - name  : astar_avoid_param
    vars  :
    - name  : enable_avoidance
      desc  : Enable avoidance mode
      ...
      cmd_param:
        dash  : ''
        delim : ':='
    - name  : avoid_waypoints_velocity
      desc  : Velocity on avoiding waypoints
      label : Waypoint Velocity [km/h]
      min   : 0.0
      max   : 40.0
      v     : 10.0
      cmd_param :
        dash  : ''
        delim : ':='
    - name  : avoid_start_velocity
      desc  : Self velocity for staring avoidance behavior
      label : Avoidance Start Velocity [km/h]
      min   : 0.0
      max   : 20.0
      v     : 3.0
      cmd_param :
    ...
    - name  : replan_interval
      desc  : Replan interval for avoidance planning
      label : Replan Interval [s]
      min   : 0.0
      max   : 10.0
      v     : 2.0
      cmd_param :
        ...
        delim : ':='
    - name  : costmap_topic
      desc  : Costmap topic for avoidance planning
      label : Costmap Topic
      kind  : str
      v     : semantics/costmap_generator/occupancy_grid
      cmd_param:
        dash  : ''
        delim : ':='
  ...
  - name  : twist_filter
    ...
    - name    : lateral_accel_limit
      desc    : the threshold that limits the lateral acceleration (m/s^2)
      label   : 'lateral_accel_limit :'
      min   : 0
      max   : 5.0
      v         : 5.0
    - name    : lateral_jerk_limit
      desc    : the threshold that limits the lateral jerk (m/s^3)
      label   : 'lateral_jerk_limit :'
      min   : 0
      max   : 5.0
      v         : 5.0
    - name    : lowpass_gain_linear_x
      desc    : the smoothing factor for exponential moving average of velocity
      label   : 'lowpass_gain_linear_x :'
      min   : 0
      max   : 1.0
      v         : 0.0
    - name    : lowpass_gain_angular_z
      desc    : the smoothing factor for exponential moving average of angular velocity
      label   : 'lowpass_gain_angular_z :'
      min   : 0
      max   : 1.0
      v         : 0.0
    - name    : lowpass_gain_steering_angle
      desc    : the smoothing factor for exponential moving average of steering angle
      label   : 'lowpass_gain_steering_angle :'
      min   : 0
      max   : 1.0
      v         : 0.0
    - name  : use_decision_maker
      desc  : If you use decision_maker, please check this true.
      label : use_decision_maker
      kind  : checkbox
      v     : False
      cmd_param :
        dash        : ''
  ...
  - name  : wf_simulator
    ...
    - name    : initialize_source
      desc    : initial pose source for wf_simulation
      label   : Initialize Source
      kind    : radio_box
      choices : ['RVIZ','NDT','GNSS', 'ORIGIN']
      descs   : ['use initialpose from 2D pose estimate in Rviz plugin  as an initial pose source', 'use ndt_pose as an initial pose source', 'use gnss_pose as an initial pose source', 'set initial pose at origin']
      choices_style: h
      choices_type : str
      v       : RVIZ
      cmd_param:
    ...
    - name    : add_measurement_noise
      desc    : add measurement noise for output topics
      label   : 'add_measurement_noise'
      kind    : checkbox
      v       : False
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : use_waypoints_for_z_position_source
      desc    : subscribe waypoints and closest index for z position source
      label   : 'use_waypoints_for_z_position_source'
      kind    : checkbox
      v       : False
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : vehicle_model_type
      desc    : vehicle model type for simulation dynamics
      label   : 'vehicle_model_type Source :'
      kind    : menu
      choices : ['IDEAL_TWIST', 'CONST_ACCEL_TWIST', 'DELAY_TWIST','IDEAL_STEER', 'DELAY_STEER']
      descs   : ['ideal twist model', 'twist model with acceleration limit', 'twist model with dead time & response delay', 'ideal steering model', 'steering model with dead time & response delay']
      choices_type : str
      v       : 'IDEAL_TWIST'
      cmd_param:
        dash     : ''
        delim    : ':='
    - name    : simulation_frame_id
      desc    : simulation_frame_id
      label   : 'tf simulation_frame_id :'
      kind    : menu
      choices : ['base_link', 'sim_base_link']
      descs   : ['', '']
      choices_type : str
      v       : 'base_link'
      cmd_param:
    ...
    - name    : lidar_frame_id
      desc    : lidar_frame_id
      label   : 'tf lidar_frame_id :'
      kind    : menu
      choices : ['velodyne', 'sim_lidar']
      descs   : ['', '']
      choices_type : str
      v       : 'velodyne'
      cmd_param:
        ...
        delim    : ':='
    - name    : sim_pose_name
      desc    : output pose topic
      label   : 'output pose topic :'
      kind    : str
      v       : 'current_pose'
      cmd_param:
        dash     : ''
        delim    : ':='
    - name    : sim_velocity_name
      desc    : output velocity topic
      label   : 'output velocity topic  :'
      kind    : str
      v       : 'current_velocity'
      cmd_param:
        dash     : ''
    ...
    - name      : angvel_rate
      desc      :
      label   : ' angular acceleration limit [rad/ss] :'
      v         : 1.0
      cmd_param :
        dash        : ''
        delim       : ':='
    ...
    - name      : vel_time_constant
      desc      :
      label   : ' velocity time constant [s] :'
      v         : 0.600
      cmd_param :
        dash        : ''
        delim       : ':='
    - name      : angvel_time_delay
      desc      :
      label   : ' angular velocity time delay [s] :'
      v         : 0.200
      cmd_param :
        dash        : ''
        delim       : ':='
    - name      : angvel_time_constant
      desc      :
      label   : ' angular velocity time constant [s] :'
      v         : 0.400
      cmd_param :
        dash        : ''
        delim       : ':='
    ...
    - name      : steer_rate_lim
      desc      :
      label   : ' steering angular velocity limit [rad/s] :'
      v         : 0.5
      cmd_param :
        dash        : ''
        delim       : ':='
    ...
    - name      : steer_time_constant
      desc      :
      label   : ' steering time constant [s] :'
      v         : 0.27
      cmd_param :
        dash        : ''
        delim       : ':='
  ...
  - name  : decision_maker
    ...
    vars  :
    - name  : disuse_vector_map
      desc  : If this is enabled, the state passes through the MapInit state without vectormap.
      label : disuse_vector_map
      kind  : checkbox
      v     : False
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : sim_mode
      desc  : If you use simulator(e.g. wf_sim) please check this true.
      label : sim_mode
      kind  : checkbox
      v     : False
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : insert_stop_line_wp
      desc  : If this is enabled, waypoint for the stop line is inserted.
      label : insert_stop_line_wp
      kind  : checkbox
      v     : True
      cmd_param :
        dash        : ''
        delim       : ':='
    - name  : num_of_steer_behind
      desc  : e
      label : num_of_steer_behind
      min   : 0
      max   : 50
      v     : 20
    - name  : goal_threshold_dist
      desc  : Threshold for transitioning to the MissionComplete state(distance between the vehicle and the end of waypoints).
      label : goal_threshold_dist[m]
      min   : 0.1
      max   : 5.0
      v     : 3.0
    - name  : goal_threshold_vel
      desc  : Threshold for transitioning to the MissionComplete state(velocity of the vehicle).
      label : goal_threshold_vel[km/h]
      min   : 0.0
      max   : 0.1
      v     : 0.1
    - name  : change_threshold_dist
      desc  : Distance threashold for DrivingMissionChange state, between current pose and new closest waypoit.
      label : change_threshold_dist[m]
      min   : 0.0
      max   : 10.0
      v     : 1.0
    - name  : change_threshold_angle
      desc  : Angle threashold for DrivingMissionChange state, between current pose and new closest waypoint.
      label : change_threshold_angle[deg]
      min   : 0.0
      max   : 90.0
      v     : 15.0
    - name  : stopped_vel
      desc  : Threshold for transitioning to the MissionComplete state(velocity of the vehicle).
      label : stopped_vel[km/h]
      min   : 0.0
      max   : 5.0
      v     : 0.1
    - name  : points_topic
    ...
    - name  : baselink_tf
      ...
      cmd_param :
              ...
              delim: ':='
    - name  : use_fms
      desc  : If this is disbled, part of state transitions are automatically executed.
      label : use_fms
      kind  : checkbox
      v     : False
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : auto_mission_reload
      desc  : If this is enabled, the mission will be automatically reloaded after the MissionComplete state.
      label : auto_mission_reload
      kind  : checkbox
      v     : False
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : auto_engage
      desc  : Automatically engage after load the mission.
      label : auto_engage
      kind  : checkbox
      v     : False
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : auto_mission_change
      desc  : The state transitions to DrivingMissionChange state automatically when load the mission while Driving state.
      label : auto_mission_change
      kind  : checkbox
      v     : False
      cmd_param :
        dash      : ''
  ...
  - name  : astar_navi_param
    ...
    - name  : use_back
      ...
      cmd_param:
        dash  : ''
        delim : ':='
    - name  : waypoints_velocity
      desc  : Velocity on planned waypoints
      label : Waypoint Velocity [km/h]
      min   : 0.0
      max   : 40.0
      v     : 5.0
    ...
    - name  : update_rate
      ...
      cmd_param :
        ...
        delim : ':='
    - name  : costmap_topic
      desc  : Costmap topic for planning
      label : Costmap Topic
      kind  : str
      v     : semantics/costmap_generator/occupancy_grid
      cmd_param :
  ...
  - name  : op_global_planner
    ...
    - name : enableSmoothing
      ...
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableRvizInput
      desc : Enable Destination selection by Rviz or from Log file
      label: Rviz Goals
      kind : checkbox
      v    : True
      cmd_param:
  ...
  - name  : op_common_params
    ...
    - name : maxAcceleration
      desc : Maximum acceleration allowed
      label: Acceleration
      min  : 0.01
      max  : 25.0
      v    : 3.0
  ...
  - name  : op_motion_predictor
    vars  :
    - name : enableCurbObstacles
      desc : Enable using curb from map as obstacles
      label: Detect curbs from map
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableGenrateBranches
      desc : to predict branching outside road network map
      ...
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : max_distance_to_lane
      desc : Distance to closest lane
      label: Distance to closest lane
      min  : 0.0
      max  : 10.0
      v    : 2.0
      cmd_param:
    ...
    - name : prediction_distance
      desc : Max trajectory prediction distance
      ...
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableStepByStepSignal
      desc : Enable Step by Step Prediction Test
      label: Enable Step by Step Test
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableParticleFilterPrediction
      desc : Use Particle Filter based trajectory predictor
      label: Enable Particle Filter prediction
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
  ...
  - name  : op_trajectory_evaluator
    ...
    - name : enablePrediction
      desc : treat all obstacles as dynamic or as static
  ...
  - name  : op_bag_player
    vars  :
    - name : rosbag_file
      desc : path to localization ready rosbag file
      label: ROSbag Path
      kind : path
      cmd_param:
        dash     : ''
  ...
  - name  : op_perception_simulator
    vars  :
    - name : simObjNumber
      desc : Max Number of simulated objects
      label: Simulated Objects Number
      min  : 1
      max  : 5
      v    : 5
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : GuassianErrorFactor
      desc : Noise factor added to simulated car position
      label: Guassian error factor
      min  : 0.0
      max  : 5.0
      v    : 0.0
      cmd_param:
  ...
  - name  : op_signs_simulator
    vars  :
    - name : first_signs_list_ids
      desc : First Traffic Light Ids
      label: First Light Ids
      kind : str
      v    : ',9,10,'
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : first_green_time
      desc : Time for 1st Traffic Light
      label: First Light Timer
      min  : 1
      max  : 100
      v    : 10
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : first_yellow_time
      desc : Time for 1st Yellow Traffic Light
      label: First Yellow Light Timer
      min  : 1
      max  : 20
      v    : 5
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : second_signs_list_ids
      desc : Second Traffic Light Ids
      label: Second Light Ids
      kind : str
      v    : ',7,8,'
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : second_green_time
      desc : Time for 2nd Traffic Light
      label: Second Light Timer
      min  : 1
      max  : 100
      v    : 10
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : second_yellow_time
      desc : Time for 2nd Yellow Traffic Light
      label: Second Yellow Light Timer
      min  : 1
      max  : 20
      v    : 5
      cmd_param:
  ...
  - name  : op_car_simulator
    vars  :
    - name : enableRvizPoseSelect
      desc : Select Start and Goal posistions from rviz
      label: Rviz Start-Goal
      kind : checkbox
      v    : True
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableLooper
      desc : Restart car after reaching the goal
      label: Auto restart
      kind : checkbox
      v    : false
      cmd_param:
        ...
        delim    : ':='
    - name : logFolder
      desc : Folder for simulation data logging
      label: Log Folder
      kind : path
      cmd_param:
        dash     : ''
    ...
    - name : maxVelocity
      ...
      cmd_param:
        ...
        delim    : ':='
    - name : maxAcceleration
      desc : maximum allowed acceleration meter/second second
      ...
      cmd_param:
        ...
        delim    : ':='
    - name : maxDeceleration
      desc : maximum allowed deceleration in meter/second second
    ...
    - name : verticalSafetyDistance
      ...
      cmd_param:
        ...
        delim    : ':='
    - name : enableStepByStepSignal
      desc : Enable Step by Step simulation motion (Testing App Required)
      label: Enable Frame by Frame
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
        delim    : ':='
    - name : enableSimulatedVelodyne
      desc : Enable broadcasting velodyne point cloud and TF from simulated car base_link
      label: Enable Dynamic Map Test
      kind : checkbox
      v    : False
      cmd_param:
        dash     : ''
  ...
  - name  : waypoint_saver
    ...
    - name      : input_type
      ...
      - LaneArrayTopic
      descs     :
      - save vehicle footprint as waypoints.csv
      - save autoware_msgs/LaneArray topic as waypoints.
      v         : 0
      cmd_param :
        dash     : ''
        delim    : ':='
    ...
    - name      : interval
      ...
      cmd_param :
        ...
        delim       : ':='
    - name      : lane_topic
      desc      : subscribed LaneArray topic name
      label     : lane topic
      v         : /lane_waypoints_array
      kind  : topic
      topic_type : autoware_msgs/LaneArray
      cmd_param :
        dash      : ''
        delim     : ':='
  ...
  - name  : waypoint_creator
    ...
    - name    : interpolation_method
      desc    : interpolation_method
      label   : interpolation_method
      kind    : radio_box
      choices : ['linear','spline']
      descs   : ['linear interpolation for input points','spline interpolation for input points']
      choices_type : str
      v       : spline
      cmd_param:
        dash     : ''
        delim    : ':='
    - name    : source_point_topic
      desc    : source points topic name to generate waypoints
      label   : 'source point topic'
      kind    : str
      v       : /clicked_point
      cmd_param :
        dash  : ''
        delim : ':='
    - name    : delete_pose_topic
      desc    : pose topic name to delete source point
      label   : 'delete pose topic'
      kind    : str
    ...
    - name      : interpolation_interval
      desc      : interval length for waypoints interpolation
      label     : interpolation_interval [m]
      v         : 1.0
    - name      : waypoint_velocity
      desc      : waypoint_velocity
      label     : waypoint_velocity
      v         : 5.0
  - name  : waypoint_loader
    topic : /config/waypoint_replanner
    msg   : ConfigWaypointReplanner
    vars  :
    - name      : load_csv
      desc      : launch waypoint_loader
      label     : load csv
      kind      : checkbox
      v         : true
      cmd_param :
    ...
    - name      : replanning_mode
      ...
      cmd_param :
        dash        : ''
        delim       : ':='
    - name      : realtime_tuning_mode
      desc      : Enable realtime tuning mode
      label     : realtime_tuning_mode
      kind      : checkbox
      v         : false
      cmd_param :
        dash        : ''
    ...
    - name      : resample_interval
      ...
      cmd_param :
        dash        : ''
        delim       : ':='
    - name      : replan_curve_mode
      desc      : Enable replan curve mode
      label     : replan curve mode
      kind      : checkbox
      v         : false
      cmd_param :
        dash        : ''
        delim       : ':='
    - name      : overwrite_vmax_mode
      desc      : Enavle overwrite velocity max mode
      label     : overwrite velocity max mode
      kind      : checkbox
      v         : false
      cmd_param :
        dash        : ''
        delim       : ':='
    - name      : replan_endpoint_mode
      desc      : Enable replan endpoint mode
      label     : replan endpoint mode
      kind      : checkbox
      v         : true
      cmd_param :
        dash        : ''
    ...
    - name      : braking_distance
      desc      : braking distance (v = vmin) for safe stopping
  ...
  - name : wayarea2grid
    ...
    - name      : grid_position_y
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : grid_position_z
      desc      : grid position z [meter]
      label     : Grid Position z [m]
      min       : -5
      max       : 5
      v         : -2.0
      cmd_param :
  ...
  - name  : lidar_euclidean_cluster_detect_param
    ...
    - name    : downsample_cloud
      ...
      cmd_param :
        ...
        delim       : ':='
    - name    : points_node
      desc    : Input PointCloud topic, use a ground filtering method from Sensing (ring, ray, comparemap)
  ...
  - name  : lidar_naive_l_shape_detect_param
    vars  :
    - name    : input_topic
      desc    : input_topic desc sample
      label   : 'input_topic'
    ...
    - name    : output_topic
      ...
      label   : 'output_topic'
      kind    : str
      v       : /detection/lidar_objects/l_shaped
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : random_ponts
      desc    : random_ponts desc sample
      label   : 'random_points'
      min       : 0
      max       : 500
      v       : 80
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : slope_dist_thres
      desc    : slope_dist_thres desc sample
      label   : 'slope_distance_threshold'
      min       : 0
      max       : 10
      v       : 2
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : num_points_thres
      desc    : num_points_thres desc sample
      label   : 'num_points_thres'
      min       : 0
      max       : 100
      v       : 10
      cmd_param :
  ...
  - name  : lidar_shape_estimation_param
    vars  :
    - name    : input
      desc    : input topic desc sample
      label   : 'input topic'
      kind  : topic
      topic_type : autoware_msgs/DetectedObjectArray
      v       : /detection/lidar_detector/objects
      cmd_param :
        dash        : ''
        delim       : ':='
    - name    : output
      desc    : output topic desc sample
      label   : 'output topic'
      kind    : str
      v       : /detection/shape_estimation/objects
      cmd_param :
        dash        : ''
        delim       : ':='
  ...
  - name  : range_vision_fusion_params
    ...
    - name  : sync_topics
      ...
      cmd_param :
        ...
        delim     : ':='
    - name  : use_vector_map
      desc  : Use ROI Filter to remove objects outside of the drivable area
      label : use_vector_map
      kind  : checkbox
      v     : False
      cmd_param :
  ...
  - name  : vision_beyond_track_params
    vars  :
    - name  : camera_info_src
      desc  : CameraInfo source topic
      label : camera_info_src
    ...
    - name  : camera_height
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
  - name  : naive_motion_predict_param
    vars  :
    - name  : input_topic
      desc  : input topic
      label : input_topic
    ...
    - name  : interval_sec
      ...
      cmd_param :
        ...
        delim     : ':='
    - name  : num_prediction
      desc  : num_prediction desc sample
      label : num_prediction
      min     : 0
      max     : 200
      v       : 20
      cmd_param :
  ...
  - name  : costmap_generator_param
    vars  :
    - name  : use_objects_box
      desc  : use bouding box from DetectedObjectArray
      label : use_objects_box
      kind  : checkbox
      v     : False
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : use_objects_convex_hull
      desc  : use convex hull from DetectedObjectArray
      label : use_objects_convex_hull
      kind  : checkbox
      v     : True
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : use_points
      desc  : use sensor_msgs::PointCloud2 or not
      label : use_points
      kind  : checkbox
      v     : True
      cmd_param :
        ...
        delim     : ':='
    - name  : use_wayarea
      desc  : use vector_map wayarea or not
      label : use_wayarea
      kind  : checkbox
      v     : True
      cmd_param :
        ...
        delim     : ':='
    - name  : objects_input
      desc  : autoware_msgs::DetectedObjectArray
      label : objects_input
      kind  : topic
      topic_type : autoware_msgs/DetectedObjectArray
      v     : /prediction/motion_predictor/objects
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : points_input
      desc  : sensor_msgs::PointCloud2
      label : points_input
      kind  : topic
      topic_type : sensor_msgs/PointCloud2
      v     : /points_no_ground
    ...
    - name    : map_frame
      ...
      cmd_param :
        ...
        delim : ':='
    - name  : grid_resolution
      desc  : grid resolution for costmap
      ...
      cmd_param :
        ...
        delim     : ':='
    - name  : grid_length_x
      desc  : grid lengh for x coordinate
      label : grid_length_x
      min     : 0.0
      max     : 100.0
      v       : 50.0
      cmd_param :
        ...
        delim     : ':='
    - name  : grid_length_y
      desc  : grid lengh for y coordinate
      label : grid_length_y
      min     : 0.0
      max     : 100.0
      v       : 30.0
      cmd_param :
        ...
        delim     : ':='
    - name  : grid_position_x
      desc  : grid position for x coordinate
      label : grid_position_x
      min     : -100.0
      max     : 100.0
      v       : 20.0
      cmd_param :
        ...
        delim     : ':='
    - name  : grid_position_y
      desc  : grid position for y coordinate
      label : grid_position_y
      min     : -100.0
      max     : 100.0
      v       : 0.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : maximum_lidar_height_thres
      desc  : Maximum z for lidar points
      label : maximum_lidar_height_thres
      min     : 0.0
      max     : 10.0
      v       : 0.3
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : minimum_lidar_height_thres
      desc  : Minimum z for lidar points
      label : minimum_lidar_height_thres
      min     : -10.0
      max     : 2.0
      v       : -2.2
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : expand_polygon_size
      desc  : Expand oberct's costmap polygon
      label : expand_polygon_size
      min     : 0.0
      max     : 10.0
      v       : 1.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : size_of_expansion_kernel
      desc  : Size of expansion window(kernel)
      label : size_of_expansion_kernel(odd number)
      min     : 0
      max     : 30
      v       : 9
      cmd_param :
  ...
  - name  : lidar_cnn_baidu_params
    vars  :
    - name      : points_src
      desc      : PointCloud topic to be fed to the network for detection
      label     : image_src
      kind  : topic
      topic_type : sensor_msgs/PointCloud2
      v         : /points_raw
    ...
    - name     : pretrained_model_file
      ...
      cmd_param:
        ...
        delim    : ':='
    - name      : use_gpu
      desc      : Whether to use GPU to process the CNN
      label     : use_gpu
      kind      : checkbox
      v         : True
      cmd_param :
    ...
    - name      : gpu_device_id
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
  - name  : lidar_point_pillars_params
    vars  :
    - name      : input_topic
      desc      : PointCloud topic to be fed to the network for detection.
      label     : Input topic
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : baselink_support
      desc      : Whether to use baselink to adujust current sensor setup.
      label     : Baselink support
      kind      : checkbox
      v         : True
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : reproduce_result_mode
      desc      : Whether to enable reproducible result at the cost of the runtime.
      label     : reproduce_result_mode
      kind      : checkbox
      v         : False
      cmd_param :
        dash      : ''
    ...
    - name  : score_threshold
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : nms_overlap_threshold
      desc  : Lower IOU than this value will be filtered.
      ...
      cmd_param :
        ...
        delim     : ':='
    - name     : pfe_onnx_file
      desc     : Pillar Feature Extractor onnx file.
      label    : 'PFE ONNX file'
      kind     : path
      v        : ''
      cmd_param:
        ...
        delim    : ':='
    - name     : rpn_onnx_file
      desc     : Region Proposal Network onnx file.
      label    : 'RPN ONNX file'
      kind     : path
      v        : ''
      cmd_param:
  ...
  - name : ekf_localizer_param
    ...
    - name      : show_debug_info
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : enable_yaw_bias_estimation
      desc      : enable yaw bias estimation for LiDAR mount error
      label     : Yaw bias estimation
      kind      : checkbox
      v         : True
      cmd_param :
        dash      : ''
    ...
    - name  : predict_frequency
      desc  : predict_frequency
      label : EKF predict frequency [Hz]
      min   : 0
      max   : 100
      v     : 50
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : extend_state_step
      desc  : EKF state extend dimension for time delay compensation
      label : extend_state_step
      min   : 1
      max   : 100
      v     : 50
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : use_pose_with_covariance
      desc      : use_pose_with_covariance
      label     : use covariance in pose_with_covariance message
      kind      : checkbox
      v         : False
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : input_pose_name
      desc      : input_pose_name (geometry_msgs/PoseStamped)
      label     : input_pose_name
      v         : /ndt_pose
      kind  : topic
      topic_type : geometry_msgs/PoseStamped
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : input_pose_with_cov_name
      desc      : input_pose_with_cov_name (geometry_msgs/PoseWithCovarianceStamped)
      label     : input_pose_with_cov_name
      v         : /ndt_pose_with_covariance
      kind  : topic
      topic_type : geometry_msgs/PoseWithCovarianceStamped
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : pose_additional_delay
      desc  : delay time added to pose delay
      label : pose additional delay [s]
      min   : 0.0
      max   : 0.5
      v     : 0.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : pose_measure_uncertainty_time
      desc  : pose measurement time uncertainty used for covariance calculation
      label : pose measurement time uncertainty [s]
      min   : 0.0
      max   : 0.5
      v     : 0.01
      cmd_param :
        ...
        delim     : ':='
    - name  : pose_rate
      desc  : pose_rate used for covariance calculation
      label : pose_rate [Hz]
      min   : 0.1
      max   : 20.0
      v     : 10.0
      cmd_param :
        ...
        delim     : ':='
    - name  : pose_gate_dist
      desc  : pose mahalanobis distance threshold
      label : pose mahalanobis distance threshold
      min   : 0.1
      max   : 100000.0
      v     : 10000.0
      cmd_param :
        ...
        delim     : ':='
    - name  : pose_stddev_x
      desc  : standard deviation of measurement noise for pose x
      label : pose_stddev_x [m]
      min   : 0.00
      max   : 0.5
      v     : 0.05
      cmd_param :
        ...
        delim     : ':='
    - name  : pose_stddev_y
      desc  : standard deviation of measurement noise for pose y
      label : pose_stddev_y [m]
      min   : 0.00
      max   : 0.5
      v     : 0.05
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : pose_stddev_yaw
      desc  : standard deviation of measurement noise for pose yaw
      label : pose_stddev_yaw [rad]
      min   : 0.00
      max   : 0.5
      v     : 0.025
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : use_twist_with_covariance
      desc      : use_twist_with_covariance
      label     : use covariance in twist_with_covariance message
      kind      : checkbox
      v         : False
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : input_twist_name
      desc      : input_twist_name (geometry_msgs/TwistStamped)
      label     : input_twist_name
      v         : /can_twist
      kind  : topic
      topic_type : geometry_msgs/TwistStamped
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : input_twist_with_cov_name
      desc      : input_twist_with_cov_name (geometry_msgs/TwistWithCovarianceStamped)
      label     : input_twist_with_cov_name
      v         : /can_twist_with_covariance
      kind  : topic
      topic_type : geometry_msgs/TwistWithCovarianceStamped
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : twist_additional_delay
      desc  : delay time added to twist
      label : twist additional delay [s]
      min   : 0.0
      max   : 0.5
      v     : 0.0
      cmd_param :
        ...
        delim     : ':='
    - name  : twist_rate
      desc  : twist_rate used for covariance calculation
      label : twist_rate [Hz]
      min   : 0.1
      max   : 100.0
      v     : 10.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : twist_gate_dist
      desc  : twist mahalanobis distance threshold
      label : twist mahalanobis distance threshold
      min   : 0.1
      max   : 100000.0
      v     : 10000.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : twist_stddev_vx
      desc  : standard deviation of measurement noise for vx
      label : twist_stddev_vx [m/s]
      min   : 0.0
      max   : 10.0
      v     : 0.2
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : twist_stddev_wz
      desc  : standard deviation of measurement noise for wz
      label : twist_stddev_wz [rad/s]
      min   : 0.0
      max   : 1.0
      v     : 0.03
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : proc_stddev_yaw_c
      desc  : standard deviation of process noise for d(yaw)/dt = wz
      label : proc_stddev_yaw
      min   : 0.000
      max   : 1.0
      v     : 0.005
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : proc_stddev_yaw_bias_c
      desc  : standard deviation of process noise for d(yaw_bias)/dt = 0
      label : proc_stddev_yaw_bias
      min   : 0.0
      max   : 0.1
      v     : 0.001
      cmd_param :
        dash      : ''
        delim     : ':='
    - name  : proc_stddev_vx_c
      desc  : standard deviation of process noise for d(vx)/dt = 0
      label : proc_stddev_vx
      min   : 0.0
      max   : 10.0
      v     : 2.0
      cmd_param :
    ...
    - name  : proc_stddev_wz_c
      desc  : standard deviation of process noise for d(wz)/dt = 0
      label : proc_stddev_wz
      min   : 0.0
      max   : 10.0
      v     : 0.2
      cmd_param :
        dash      : ''
        delim     : ':='
  - name : vehicle_status_converter_param
    vars :
    - name      : enable_adaptive_estimate
      desc      : enable adaptive coefficient estimation with /estimate_twist by recursive least square method
      label     : enable_adaptive_estimate
      kind      : checkbox
      v         : true
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : enable_steering_offset_estimate
      desc      : enable steering offset estimation with /estimate_twist by recursive least square method
      label     : enable_steering_offset_estimate
      kind      : checkbox
      v         : false
      cmd_param :
        dash      : ''
  ...
  - name : vel_pose_diff_checker
    ...
    - name      : loop_rate_hz
      ...
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : comparison_window_size_sec
      desc      : Comparison window size [sec]
      label     : comparison_window_size_sec
      min   : 0.1
      max   : 10.0
      v     : 1.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : topic_timeout_sec
      desc      : Topic timeout [sec]
      label     : topic_timeout_sec
      min   : 0.1
      max   : 10.0
      v     : 0.3
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : moving_median_window_size_sec
      desc      : Moving median window size [sec]
      label     : moving_median_window_size_sec
      min   : 0.1
      max   : 10.0
      v     : 2.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : diff_position_threshold_meter
      desc      : Threshold value for position difference [meter]
      label     : diff_position_threshold_meter
      min   : 0.01
      max   : 10.0
      v     : 1.0
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : diff_position_median_threshold_meter
      desc      : Threshold value for moving median of position difference [meter]
      label     : diff_position_median_threshold_meter
      min   : 0.01
      max   : 10.0
      v     : 0.5
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : diff_angle_threshold_rad
      desc      : Threshold value for angle difference [rad]
      label     : diff_angle_threshold_rad
      min   : 0.01
      max   : 1.0
      v     : 0.1
      cmd_param :
        dash      : ''
        delim     : ':='
    - name      : diff_angle_median_threshold_rad
      desc      : Threshold value for moving median of angle difference [rad]
      label     : diff_angle_median_threshold_rad
      min   : 0.01
      max   : 1.0
      v     : 0.05
      cmd_param :
